  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        secondary: {
          DEFAULT: "var(--color-secondary)", /* teal-900 */
        ...
        textPrimary: "var(--color-text-primary)", /* slate-800 */
      ...
      boxShadow: {
        'cta': '0 4px 14px 0 rgba(15, 118, 110, 0.15)',
        'dashboard': '0 8px 25px 0 rgba(0, 77, 64, 0.12)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
